...
namespace PR_tool::parse {
    ...
    auto write_control_bits_pair(hardware::Interposer* interposer, const std::FilePath& full_output_path, const std::FilePath& simplified_output_path, int mode) -> void;
