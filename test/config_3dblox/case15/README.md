# case15: PR_tool to 3DBlox package

Load this package from its directory with:

```tcl
source load_case15.tcl
```

`case15.3dbx` and its included `.3dbv` are standard 3DBlox.  Its external
...
adjacent `case15_connectivity.v` instead.  That connectivity is standard
