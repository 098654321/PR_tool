...
`case2.3dbx` and its included `.3dbv` are standard 3DBlox.  The top
...
plus bump maps only; `case2_interposer.def` and
`case2_interposer_macros.lef` are still emitted for later drawing but
